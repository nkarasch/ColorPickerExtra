namespace ColorPickerExtraLib.Models
{
    public struct ColorState
    {
        ...
        {
            System.Tuple<double, double, double> hsltuple = ColorSpaceHelper.RgbToHsl(_RGB_R, _RGB_G, _RGB_B);
        ...
        {
            System.Tuple<double, double, double> hsvtuple = ColorSpaceHelper.HslToHsv(_HSL_H, _HSL_S, _HSL_L);
            double h = hsvtuple.Item1, s = hsvtuple.Item2, v = hsvtuple.Item3;
            _HSV_H = h;
            if (s != -1)
                _HSV_S = s;
        ...
        {
            System.Tuple<double, double, double> rgbtuple = ColorSpaceHelper.HslToRgb(_HSL_H, _HSL_S, _HSL_L);
        ...
        {
            System.Tuple<double, double, double> rgbtuple = ColorSpaceHelper.HsvToRgb(_HSV_H, _HSV_S, _HSV_V);
            _RGB_R = rgbtuple.Item1;
            _RGB_G = rgbtuple.Item2;
            _RGB_B = rgbtuple.Item3;
        }
